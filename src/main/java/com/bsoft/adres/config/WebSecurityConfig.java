...
//            config.setAllowedOrigins(List.of("http://localhost:4200", "http://localhost:80", "http://localhost:81", "http://localhost:8080", "https://editor.swagger.io/", "https://editor-next.swagger.io/"));
