...
insert into "user" (id, username, password, email, phone, accountNonExpired, accountNonLocked, credentialsNonExpired,
                   enabled)
values (1, 'admin', '12345', 'admin-01@gmail.com', '0645342321', true, true, true, true);
insert into "user" (id, username, password, email, phone, accountNonExpired, accountNonLocked, credentialsNonExpired,
                   enabled)
values (2, 'user', '12345', 'admin-02@gmail.com', '0645342321', true, true, true, true);
insert into "user" (id, username, password, email, phone, accountNonExpired, accountNonLocked, credentialsNonExpired,
                   enabled)
values (3, 'bvpelt', '12345', 'admin-03@gmail.com', '0645342321', true, true, true, true);
