...
// @ts-ignore
import { LoginTestResponse } from '../model/login-test-response';
// @ts-ignore
...
export class LoginService implements LoginServiceInterface {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public postTestLogin(loginRequest: LoginRequest, xAPIKEY?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<LoginTestResponse>;
    ...
    public postTestLogin(loginRequest: LoginRequest, xAPIKEY?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<LoginTestResponse>>;
    public postTestLogin(loginRequest: LoginRequest, xAPIKEY?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'application/problem+json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (loginRequest === null || loginRequest === undefined) {
            throw new Error('Required parameter loginRequest was null or undefined when calling postTestLogin.');
        }
        ...
        let localVarPath = `/login/test`;
        return this.httpClient.request<LoginTestResponse>('post', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                body: loginRequest,
                responseType: <any>responseType_,
